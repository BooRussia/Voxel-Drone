...
function boot() {
  ...
  const keys = [
    { t: 0, pos: [0.1, 0.16, 1.42], look: [0, 0, 0.55], yaw: 0, pitch: 0.04, fov: 24 },
    { t: 0.2, pos: [0.18, 0.18, 1.58], look: [0, 0, 0.42], yaw: 0.16, pitch: 0.05, fov: 25 },
    { t: 0.4, pos: [0.52, 0.14, 1.48], look: [0, 0, 0.32], yaw: 0.48, pitch: 0.05, fov: 26 },
    { t: 0.6, pos: [0.88, 0.18, 1.18], look: [0, 0, 0.18], yaw: 0.88, pitch: 0.02, fov: 27 },
    { t: 0.8, pos: [0.28, 0.14, 1.5], look: [0, 0, 0.4], yaw: 0.24, pitch: 0.04, fov: 25 },
    { t: 1, pos: [0.58, 0.12, 1.38], look: [0.1, 0, 0.48], yaw: 0.12, pitch: 0.03, fov: 24 },
  ];
